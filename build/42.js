...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LmtagtraininghandoverinfoPageModule", function() { return LmtagtraininghandoverinfoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lmtagtraininghandoverinfo__ = __webpack_require__(1629);
...
var LmtagtraininghandoverinfoPageModule = /** @class */ (function () {
    function LmtagtraininghandoverinfoPageModule() {
    }
    LmtagtraininghandoverinfoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lmtagtraininghandoverinfo__["a" /* LmtagtraininghandoverinfoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lmtagtraininghandoverinfo__["a" /* LmtagtraininghandoverinfoPage */]),
            ],
        })
    ], LmtagtraininghandoverinfoPageModule);
    return LmtagtraininghandoverinfoPageModule;
}());

//# sourceMappingURL=lmtagtraininghandoverinfo.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LmtagtraininghandoverinfoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
 ...
 */
var LmtagtraininghandoverinfoPage = /** @class */ (function () {
    // public archiveid = null
    function LmtagtraininghandoverinfoPage(navCtrl, navParams, httpService, phoneDevice, platform, toastCtrl, permission, file, camera, events, transfer, fileopen, loadingCtrl, configProvider, menuCtrl, actionsheetCtrl, storage) {
    ...
    LmtagtraininghandoverinfoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad LmtagarchivemanagePage');
    };
    LmtagtraininghandoverinfoPage.prototype.ionViewWillEnter = function () {
        this.projectid = this.storage.get(__WEBPACK_IMPORTED_MODULE_10__providers_storage__["a" /* StorageProvider */].LM_PROJECTID);
        if (this.projectid) {
            this.initlist();
        }
    };
    LmtagtraininghandoverinfoPage.prototype.doRefresh = function (refresher) {
        this.initlist();
        setTimeout(function () {
    ...
    // 本地搜索+防抖
    LmtagtraininghandoverinfoPage.prototype.handleSearch = function () {
        var _this = this;
    ...
    LmtagtraininghandoverinfoPage.prototype.initlist = function () {
        var _this = this;
        this.list = [];
        this.httpService.getFiles('lmtagTrainingHandover', this.info['thid'], function (res) {
            if (res.code == 0) {
                _this.list = res.data;
            }
        });
    };
    LmtagtraininghandoverinfoPage.prototype.saveForm = function () {
        var _this = this;
        // 回调列表页，保存整个列表
    ...
    // 文件上传相关 START
    LmtagtraininghandoverinfoPage.prototype.clickUpload = function () {
        // $('#file').click()
        this.photo('lmtagTrainingHandover', false);
    };
    LmtagtraininghandoverinfoPage.prototype.beforeUpload2 = function (e) {
        var _this = this;
        ...
        formdata.append('bussid', this.info['thid']);
    ...
    LmtagtraininghandoverinfoPage.prototype.photo = function (busstype, video) {
        var _this = this;
    ...
    LmtagtraininghandoverinfoPage.prototype.doCamera = function (sourceType, busstype, video) {
        var _this = this;
        var mediatype = 0;
        if (video) {
            mediatype = 1;
        ...
        this.camera.getPicture(options).then(function (imageData) {
            // 获取成功
            _this.httpService.uploadify(busstype, _this.info['thid'], imageData, function (result) {
                _this.initlist();
            });
        });
    };
    // 文件上传相关 END
    // 文件大小格式化
    LmtagtraininghandoverinfoPage.prototype.formatBytes = function (size) {
        var data = "";
        if (size < 0.1 * 1024) {
    ...
    LmtagtraininghandoverinfoPage.prototype.removeFile = function (item) {
        var _this = this;
    ...
    // 下载相关函数
    LmtagtraininghandoverinfoPage.prototype.checkPermissions = function () {
    ...
    LmtagtraininghandoverinfoPage.prototype.openFile = function (item) {
        var _this = this;
    ...
    ], LmtagtraininghandoverinfoPage);
    return LmtagtraininghandoverinfoPage;
}());

//# sourceMappingURL=lmtagtraininghandoverinfo.js.map
