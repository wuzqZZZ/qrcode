...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LmtagsummaryspecialtyinfoPage; });
...
/**
 * Generated class for the LmtagsummaryspecialtyinfoPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var LmtagsummaryspecialtyinfoPage = /** @class */ (function () {
    function LmtagsummaryspecialtyinfoPage(navCtrl, navParams, phoneDevice, trusturl, platform, httpService, alertCtrl, toastCtrl, events) {
        var _this = this;
        ...
        // public src = '/lmtagSummarySpecialty/edit/8a2db5f4e6a04491845b2ba14ec7f931';
        this.code = 'lmtagSummarySpecialty';
    ...
    LmtagsummaryspecialtyinfoPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.findProjectInfo();
        // console.log($('#iframe')[0].contentWindow.innerWidth);
        // console.log($('#iframe')[0].contentWindow.document.body);
        this.events.subscribe('workflowPage', function (flag, time) {
            console.log('发送流程返回: ' + flag, time);
            _this.updateInfo();
        });
        if (this.info['wfid']) {
    ...
    LmtagsummaryspecialtyinfoPage.prototype.autoComputeIframe = function () {
        var _this = this;
        setTimeout(function () {
    ...
    LmtagsummaryspecialtyinfoPage.prototype.showbigcontent = function () {
        $('#iframe')[0].contentWindow.document.body.children[0].style['zoom'] = 2;
    };
    LmtagsummaryspecialtyinfoPage.prototype.findProjectInfo = function () {
        var _this = this;
    ...
    //读取用户是否有工作流按钮权限
    LmtagsummaryspecialtyinfoPage.prototype.getButtonControl = function () {
        var _this = this;
    ...
    LmtagsummaryspecialtyinfoPage.prototype.send = function () {
        if (this.info['wfid'] != "" && this.info['wfid'] != null) {
            // 审核流程
    ...
    //读取用户是否有撤回流程权限
    LmtagsummaryspecialtyinfoPage.prototype.checkFetchBack = function () {
        var _this = this;
    ...
    LmtagsummaryspecialtyinfoPage.prototype.fetchBack = function () {
        var _this = this;
    ...
    LmtagsummaryspecialtyinfoPage.prototype.historyview = function () {
        this.navCtrl.push('HistorylistPage', {
            wfid: this.info['wfid'],
            title: '流程历史',
        });
    };
    LmtagsummaryspecialtyinfoPage.prototype.goback = function () {
        this.navCtrl.pop();
    };
    LmtagsummaryspecialtyinfoPage.prototype.updateInfo = function () {
        var _this = this;
    ...
    ], LmtagsummaryspecialtyinfoPage);
    return LmtagsummaryspecialtyinfoPage;
}());

//# sourceMappingURL=lmtagsummaryspecialtyinfo.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LmtagsummaryspecialtyinfoPageModule", function() { return LmtagsummaryspecialtyinfoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lmtagsummaryspecialtyinfo__ = __webpack_require__(1581);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LmtagsummaryspecialtyinfoPageModule = /** @class */ (function () {
    function LmtagsummaryspecialtyinfoPageModule() {
    }
    LmtagsummaryspecialtyinfoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lmtagsummaryspecialtyinfo__["a" /* LmtagsummaryspecialtyinfoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lmtagsummaryspecialtyinfo__["a" /* LmtagsummaryspecialtyinfoPage */]),
            ],
        })
    ], LmtagsummaryspecialtyinfoPageModule);
    return LmtagsummaryspecialtyinfoPageModule;
}());

//# sourceMappingURL=lmtagsummaryspecialtyinfo.module.js.map
