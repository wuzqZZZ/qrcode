...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LmtagsummaryinfoPage; });
...
/**
 * Generated class for the LmtagsummaryinfoPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var LmtagsummaryinfoPage = /** @class */ (function () {
    function LmtagsummaryinfoPage(navCtrl, navParams, phoneDevice, trusturl, platform, httpService, alertCtrl, toastCtrl, events) {
        ...
        if (this.info['summaryid']) {
            ...
            // this.src = `${ConfigProvider.apiUrl}/attach/download/lmtagOfficeSummary/31f2de2520e04b8689d070bb843271b6`
    ...
    LmtagsummaryinfoPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    LmtagsummaryinfoPage.prototype.autoComputeIframe = function () {
        var _this = this;
        setTimeout(function () {
    ...
    LmtagsummaryinfoPage.prototype.showbigcontent = function () {
        $('#iframe')[0].contentWindow.document.body.children[0].style['zoom'] = 2;
    };
    LmtagsummaryinfoPage.prototype.findProjectInfo = function () {
        var _this = this;
    ...
    //读取用户是否有工作流按钮权限
    LmtagsummaryinfoPage.prototype.getButtonControl = function () {
        var _this = this;
    ...
    LmtagsummaryinfoPage.prototype.send = function () {
    ...
    //读取用户是否有撤回流程权限
    LmtagsummaryinfoPage.prototype.checkFetchBack = function () {
        var _this = this;
    ...
    LmtagsummaryinfoPage.prototype.fetchBack = function () {
        var _this = this;
    ...
    LmtagsummaryinfoPage.prototype.historyview = function () {
        this.navCtrl.push('HistorylistPage', {
            wfid: this.info['wfid'],
            title: '流程历史',
        });
    };
    LmtagsummaryinfoPage.prototype.goback = function () {
        this.navCtrl.pop();
    };
    LmtagsummaryinfoPage.prototype.updateWfstatus = function () {
        var _this = this;
    ...
    ], LmtagsummaryinfoPage);
    return LmtagsummaryinfoPage;
}());

//# sourceMappingURL=lmtagsummaryinfo.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LmtagsummaryinfoPageModule", function() { return LmtagsummaryinfoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lmtagsummaryinfo__ = __webpack_require__(1579);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LmtagsummaryinfoPageModule = /** @class */ (function () {
    function LmtagsummaryinfoPageModule() {
    }
    LmtagsummaryinfoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lmtagsummaryinfo__["a" /* LmtagsummaryinfoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lmtagsummaryinfo__["a" /* LmtagsummaryinfoPage */]),
            ],
        })
    ], LmtagsummaryinfoPageModule);
    return LmtagsummaryinfoPageModule;
}());

//# sourceMappingURL=lmtagsummaryinfo.module.js.map
