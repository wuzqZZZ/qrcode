...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LmtagreportdailyinfoPage; });
...
var LmtagreportdailyinfoPage = /** @class */ (function () {
    function LmtagreportdailyinfoPage(events, storage, navCtrl, toastCtrl, navParams, httpService, workflow, tools, phoneDevice) {
        this.events = events;
        ...
        this.formdata = [
            { 'name': '检修机组', 'index': 'unittypename', 'type': 'text', "placeholder": '请填写检修机组', 'starttoggle': true, 'toggleindex': 'createtime', 'plantitle': '基本信息' },
            { 'name': '检修等级', 'index': 'checklevel', 'type': 'text', "placeholder": '请填写检修等级' },
            { 'name': '检修开始', 'index': 'phase', 'type': 'text', "placeholder": '请填写检修开始' },
            { 'name': '计划启动日期', 'index': 'planstarttime', 'type': 'datetime', "placeholder": '请选择日期', 'format': 'YYYY-MM-DD' },
            { 'name': '计划结束日期', 'index': 'planendtime', 'type': 'datetime', "placeholder": '请选择日期', 'format': 'YYYY-MM-DD' },
            { 'name': '日报日期', 'index': 'reportdate', 'type': 'datetime', "placeholder": '请选择日期', 'format': 'YYYY-MM-DD' },
            { 'name': '日报描述', 'index': 'description', 'type': 'textarea', 'placeholder': '请填写日报描述' },
        ];
        this.forminfo = {};
        this.id = '';
        this.type = '';
    ...
    LmtagreportdailyinfoPage.prototype.ionViewDidLoad = function () {
        // console.log('ionViewDidLoad PiinoutinfoPage');
    };
    LmtagreportdailyinfoPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    LmtagreportdailyinfoPage.prototype.initPrjname = function (id) {
        var _this = this;
    ...
    LmtagreportdailyinfoPage.prototype.collapseClick = function (index) {
        $('page-lmtagreportdailyinfo #collapse' + index).toggle();
        $('page-lmtagreportdailyinfo .collapse_show_icon' + index).toggle();
        $('page-lmtagreportdailyinfo .collapse_hide_icon' + index).toggle();
    };
    LmtagreportdailyinfoPage.prototype.pageElementControl = function (data) {
        this.pageControl = data;
    };
    LmtagreportdailyinfoPage.prototype.pageElement = function (wfstatus, wfid) {
        return __awaiter(this, void 0, void 0, function () {
            var data, array;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpService.getPageControlElementAnsy("lmtagreportdailyinfo_form", wfstatus, wfid)];
                    case 1:
                        data = _a.sent();
    ...
    LmtagreportdailyinfoPage.prototype.initstatus = function (status) {
        var _this = this;
    ...
    LmtagreportdailyinfoPage.prototype.initConformitycode = function (conformityid) {
        var _this = this;
        this.httpService.get('/lmtagreportdailyinfo/detail/' + conformityid, null, function (result) {
            if (result.code == 0) {
    ...
    LmtagreportdailyinfoPage.prototype.selectitem = function (item) {
    ...
    LmtagreportdailyinfoPage.prototype.initinfo = function () {
        var _this = this;
        var that = this;
        if (this.type == 'edit') {
            var url = "/query/danger/lmtagReportDaily/findOne?id=" + this.id;
            this.httpService.get(url, null, function (result) {
                ...
                if (result.code == 0) {
                    if (result.data.length > 0) {
                        ...
                        _this.httpService.inittime('reportdate', _this.forminfo);
                        ...
                        if (_this.forminfo['unittype']) {
                            _this.forminfo['unittypename'] = "#" + _this.forminfo['unittype'] + " \u673A\u7EC4";
                        }
                    }
                }
            });
    ...
    LmtagreportdailyinfoPage.prototype.initlist = function () {
        var _this = this;
    ...
    LmtagreportdailyinfoPage.prototype.submit = function () {
        var _this = this;
        if (this.tools.initform(this.formdata, this.forminfo)) {
            ...
            this.httpService.initsavetime('reportdate', this.forminfo);
            this.httpService.initsavetime('planstarttime', this.forminfo);
            this.httpService.initsavetime('planendtime', this.forminfo);
            this.httpService.postform('/lmtagReportDaily/save', 'lmtagReportDaily', this.forminfo, function (res) {
                if (res.code == 0) {
                    _this.initinfo();
    ...
    LmtagreportdailyinfoPage.prototype.historyview = function () {
        this.navCtrl.push('HistorylistPage', {
            wfid: this.forminfo['wfid'],
            title: '流程历史',
        });
    };
    LmtagreportdailyinfoPage.prototype.workflowStart = function () {
        // this.saveStr = "true";
    ...
    ], LmtagreportdailyinfoPage);
    return LmtagreportdailyinfoPage;
}());

//# sourceMappingURL=lmtagreportdailyinfo.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LmtagreportdailyinfoPageModule", function() { return LmtagreportdailyinfoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lmtagreportdailyinfo__ = __webpack_require__(1624);
...
var LmtagreportdailyinfoPageModule = /** @class */ (function () {
    function LmtagreportdailyinfoPageModule() {
    }
    LmtagreportdailyinfoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__lmtagreportdailyinfo__["a" /* LmtagreportdailyinfoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__lmtagreportdailyinfo__["a" /* LmtagreportdailyinfoPage */]), __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], LmtagreportdailyinfoPageModule);
    return LmtagreportdailyinfoPageModule;
}());

//# sourceMappingURL=lmtagreportdailyinfo.module.js.map
